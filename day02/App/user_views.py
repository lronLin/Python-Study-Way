...
def set_cookie():
    ...
    # 绑定cookie值, set_cookie(key, value, max_ages, expires)
    res.set_cookie('ticket', '123123123', max_ages=10)
...
def del_cookie():
    ...
    # 服务端创建响应
    res = make_response(temp)
    # 绑定cookie值, delete_cookie(key, value, max_ages, expires)
...
def stu_scores():
    ...
    content_h2 = '<h2>二班男生们最美</h2>'
    content_h3 = '<h3>二班男生们最美</h3>'
